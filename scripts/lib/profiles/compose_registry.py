...
COMPOSE_REGISTRY = {
    ...
    "vllm/gemma-26ba4b-single": _entry(
        ...
        compose_path="models/gemma-4-26b-a4b/vllm/compose/single/awq/base.yml",
        default_port=8040,
        kvcalc_key="SKIP",
        status="experimental",
        status_note="AWQ MoE on stock v0.22.0 — boot+coherence validated 2026-06-05 (1x 3090, Marlin WNA16 MoE, ~22 GB). Promote after rebench-full + soak.",
    ),
    "vllm/gemma-26ba4b-dual": _entry(
        ...
        kvcalc_key="SKIP",
        status="experimental",
        status_note="AWQ + external MTP (gemma-26b-it-assistant n=4) on stock v0.22.0 — MTP +55% TPS (134->208, AL 3.55) validated 2026-06-05. Promote after rebench-full + soak.",
    ),
